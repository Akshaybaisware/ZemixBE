    ...
    const mailOptions = {
      ...
      html: `
            <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: 0 auto; background-color: #f4f4f4; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
              ...
              <p style="font-size: 16px; text-align: justify;">Dear ${
                user.name
              },</p>
              ...
              <ul style="list-style: none; padding: 0; margin: 0;">
                <li style="font-size: 16px;"><strong>Name of the Employee:</strong> ${
                  user.name
                }</li>
                <li style="font-size: 16px;"><strong>Email:</strong> ${
                  user.email
                }</li>
                <li style="font-size: 16px;"><strong>Phone:</strong> ${
                  user.mobile
                }</li>
              </ul>
              ...
              }/userlogin" style="color: #007bff; text-decoration: none; display: inline-block; margin-top: 10px; padding: 10px 20px; background-color: #007bff; color: #fff; border-radius: 5px; text-align: center;">Click here to get started</a></p>
              ...
              <p style="font-size: 16px;"><strong>Initial Starting Date:</strong> ${formatDate(
                user.startDate
              )} | <strong>Account Expiry Date:</strong> ${formatDate(
        user.endDate
      )}</p>
              <hr style="border: 1px solid #ddd; margin: 15px 0;">
              ...
              <p style="font-size: 16px;">You can download your signed agreement <a href="https://zemixservices.netlify.app/employmentformdetails/${
                aggrUserId._id
              }" style="color: #007bff; text-decoration: none;">here</a></p>
